...
library("abind")
##read in tree file
tree_test <- read.newick("RAxML_bipartitions.result")
...
wagner <- ggtree(tree_test, branch.length="true",aes(color=group, linetype="solid")) + 
  geom_cladelabel(219, label="Amphipyrinae", fontsize=6, align = TRUE, offset=0.5) + 
  geom_cladelabel(199, label="Stiriinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(193, label="Metoponiinae+\nCydosiinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(191, label="Grotellinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(215, label="Oncocnemidinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(251, label="Condicinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(166, label="Acontiinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(258, label="Bryophilinae", fontsize=6, align = TRUE, offset=0.5) +
  geom_cladelabel(261, label="Noctuinae", fontsize=6, align = TRUE, offset=0.5) +
